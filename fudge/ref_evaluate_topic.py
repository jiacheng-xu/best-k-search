...
from ref_predict_topic import predict
...
if __name__=='__main__':
    ...
    # DATA
    parser.add_argument('--ckpt', type=str, default="/export/home/experimental/naacl-2021-fudge-controlled-generation/ckpt/topic/future_word_predictor/model.pth.tar")
    parser.add_argument('--log_file', type=str, default='topic_preds.log', help='file to write outputs to (csv format)')
    parser.add_argument('--dataset_info', type=str, default='/export/home/experimental/naacl-2021-fudge-controlled-generation/ckpt/topic/future_word_predictor/dataset_info', help='saved dataset info')
    ...
    parser.add_argument('--prefix_file', type=str, default='/export/home/experimental/naacl-2021-fudge-controlled-generation/topic_data/topic_prefixes.txt', help='prefix set')
    ...
    parser.add_argument('--condition_lambda', type=float, default=4, help='lambda weight on conditioning model')
    parser.add_argument('--length_cutoff', type=int, default=20, help='max length')
